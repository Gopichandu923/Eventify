    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh] bg-[#0a0a0c] px-4">
        <div className="text-center glass-card p-10 rounded-3xl border-rose-500/20 max-w-sm w-full">
          ...
          <Link href="/organizer/dashboard" className="inline-block w-full px-6 py-4 bg-white text-indigo-600 text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-neutral-100 transition-all shadow-xl shadow-white/5">
    ...
    <div className="min-h-screen py-4 md:py-6 px-4 md:px-8 relative overflow-x-hidden bg-[#0a0a0c]">
      ...
      <div className="max-w-7xl mx-auto space-y-4">
        <div className="flex items-center justify-between bg-white/[0.02] p-4 rounded-2xl border border-white/5">
          <Link href="/organizer/dashboard" className="flex items-center gap-2 text-gray-500 hover:text-white transition-colors text-[9px] font-black uppercase tracking-widest group">
            ...
            <div className="flex flex-wrap gap-1.5">
              {[
                ...
                <button
                  ...
                  className={`px-2.5 py-1.5 rounded-lg text-[8px] md:text-[9px] font-black uppercase tracking-widest transition-all ${
                    filter === f.id
                  ...
                  filteredRegistrations.map((reg) => (
                    <tr key={reg._id} className="hover:bg-white/[0.01] transition-colors group">
                      ...
                      <td className="px-4 md:px-6 py-3 text-center">
                        <div className={`px-2 py-0.5 rounded text-[7px] md:text-[8px] font-black uppercase tracking-widest inline-block ${
                          reg.status === "Approved"
